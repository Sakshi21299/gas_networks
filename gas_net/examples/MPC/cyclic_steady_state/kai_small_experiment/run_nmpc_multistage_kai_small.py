# -*- coding: utf-8 -*-
"""
Created on Mon Jan 27 12:30:47 2025
...
def run_nmpc(simulation_steps = 24, 
    ...
    m_controller_1, m_plant = make_plant_and_controller_model(ocss_file_path = ocss_file_path_min, input_data_path = input_data_path,
                                                              ...
                                                              uncertainty={(0, 13): min_value, (13, 25): max_value, 
                                                                           (25, 37): min_value, (37, 49): max_value, 
                                                                           (49, 61): min_value, (61, 73): max_value,
                                                                           (73, 85): min_value, (85, 97): max_value,
                                                                           (97, 109): min_value, (109, 121): max_value,
                                                                           (121, 133): min_value, (133, 145): max_value})
    ...
    m_controller_3, _ = make_plant_and_controller_model(ocss_file_path = ocss_file_path_max, input_data_path = input_data_path, 
                                                        network_data_path=network_data_path, options_data_path=options_data_path,
                                                        horizon = controller_horizon, num_time_periods= num_time_periods,
                                                        uncertainty={(0, 13): max_value, (13, 25): min_value, 
                                                                     (25, 37): max_value, (37, 49): min_value, 
                                                                     (49, 61): max_value, (61, 73): min_value,
                                                                     (73, 85): max_value, (85, 97): min_value,
                                                                     (97, 109): max_value, (109, 121): min_value,
                                                                     (121, 133): max_value, (133, 145): min_value})
    ...
    #Plant demand
    np.random.seed(605)
    uncertainty = np.random.uniform(low=min_value, high=max_value, size=(73,))
    uncertainty_dict = {}
    ...
    plt.figure()
    plt.plot(demand_data_controller_3['sink_1'][:73], '--b',label = "Max")
    plt.plot(demand_data_controller_2['sink_1'][:73], '-k',label = "Nominal")
    plt.plot(demand_data_controller_1['sink_1'][:73], "--r", label = "Min")
    ...
    for i in range(simulation_steps):
        ...
        plt.show()
    print(timer)
    with open('hierarchical_timer_kai_multistage.txt', 'w') as f:
        f.write(str(timer))
...
if __name__ =="__main__":
    ocss_file_path_min = r"C:\Users\ssnaik\Biegler\gas_networks_italy\gas_networks\gas_net\optimal_css_24hrs_kai_min_demand.xlsx"
    ocss_file_path_nominal = r"C:\Users\ssnaik\Biegler\gas_networks_italy\gas_networks\gas_net\optimal_css_24hrs_kai.xlsx"
    ocss_file_path_max = r"C:\Users\ssnaik\Biegler\gas_networks_italy\gas_networks\gas_net\optimal_css_24hrs_kai_max_demand.xlsx"
