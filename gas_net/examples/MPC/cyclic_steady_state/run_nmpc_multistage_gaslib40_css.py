...
if __name__ =="__main__":
    ...
    write_data_to_excel(sim_data, m_plant, sheets_keys_dict, "enmpc_multistage_gaslib40_72hrs_random_scenario_explicit_terminal_constraints_avg_stability_l1_slack.xlsx",
                        controller_1_lyapunov=controller_1_lyapunov_function,
                        controller_2_lyapunov=controller_2_lyapunov_function,
                        controller_3_lyapunov=controller_3_lyapunov_function)
